...
// Form to Discord Log
function SendFormWebhook() {	
	const request = new XMLHttpRequest();		  
	var name = document.getElementById("nameentered").value;
	var email = document.getElementById("emailentered").value;
	var message = document.getElementById("textentered").value;	
	request.open("POST", "https://discord.com/api/webhooks/919946476669513798/QDeXiIforUrLsgAZ4ViPpPzxcT2nBAJ9jeCpU5K37xpWryulDqxsYyN4xnzFL-5kmYuv");
	...
	var myEmbed = {
		...
		title: "New Form Recieved",
		description: "Name: "+name+" \n"+"Email: "+email+" \n"+"Message: "+message,
		color: hexToDecimal("#ff0000")
	  }
	  
	  var params = {
		username: "Margik Bhatt - Website",
		embeds: [ myEmbed ]
	  }
	  ...
	  setTimeout(function(){  $('.alert-success').fadeOut(); $('#cform').delay(500).fadeIn(); }, 5000);	  
}
